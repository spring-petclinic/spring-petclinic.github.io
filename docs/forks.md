...
|[spring-petclinic-microservices-on-azure] | ![stars](https://github.com/azure-samples/spring-petclinic-microservices.svg?style=social&label=Star) | Deploy distributed version of Spring Petclinic built with Spring Cloud and Netflix OSS to Azure Spring Cloud                                                            | ![](../images/icon-spring-cloud.png)    |
